...
//     });
//   }, [certificates, students, searchTerm]);

//   return (
//     <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 lg:px-6">
//       <div className="">
...
//               </div>
//               <h1 className="text-4xl font-bold text-gray-800">Issued Certificates</h1>
//             </div>
//             <p className="text-gray-600 ml-14">
//               Manage and download student certificates
//             </p>
//           </div>
...
//               <CertificateCard key={cert.id} cert={cert} students={students} />
//             ))}
//           </div>
//         )}
//       </div>
...
// import { Award, Loader } from "lucide-react";
// import CertificateCard from "./CertificateCard";
// import CertificateTemplate from "./CertificateTemplate"; // <-- import your template
// import { collection, getDocs } from "firebase/firestore";
// import { db } from "../firebase/config";
// import type { Coursetype, StudentDetails } from "../type/auth";
// import { subscribeStudents } from "../utils/studentUtils";
...
// /** Helper: get all payments for all students */
// const getAllPayments = async () => {
//   const paymentsSnap = await getDocs(collection(db, "payments"));
//   return paymentsSnap.docs.map(doc => ({ id: doc.id, ...doc.data() }));
// };
...
//   // Modal state for certificate generation
//   const [showCertModal, setShowCertModal] = useState(false);
//   const [modalStudent, setModalStudent] = useState<StudentDetails | null>(null);
//   const [modalCourseName, setModalCourseName] = useState<string | null>(null);
...
//   // Certificates with issued/pending status
//   const displayCertificates = useMemo(() => {
//     const issued = certificates.map(cert => {
//       const student = students.find(s => s.id === cert.studentId);
//       return {
...
//       return studentName.includes(term) || courseName.includes(term);
//     });
//   }, [certificates, students, payments, searchTerm, courses]);
...
//   // Handler after certificate is uploaded
//   const handleCertUploaded = () => {
//     setShowCertModal(false);
//     setModalStudent(null);
//     setModalCourseName(null);
...
//               <Award size={28} className="text-white" />
//             </div>
//             <h1 className="text-4xl font-bold text-gray-800">Issued & Pending Certificates</h1>
//           </div>
//           <p className="text-gray-600 ml-14">
//             Manage and download student certificates, and view pending ones
//           </p>
...
//           <div className="bg-gradient-to-br from-green-500/2 to-emerald-500/20 border border-green-500/30 rounded-xl p-4">
...
//           </div>
//           <div className="bg-gradient-to-br from-green-500/2 to-emerald-500/20 border border-green-500/30 rounded-xl p-4">
//             <p className="text-green-300 text-sm font-medium">Issued</p>
//             <p className="text-3xl font-bold text-green-400 mt-1">
//               {displayCertificates.filter(c => c.status === "issued").length}
//             </p>
//           </div>
...
//               {cert.status === "pending" && (
//                 <button
//                   className="absolute top-4 right-4 bg-amber-600 text-white px-3 py-1 rounded-lg shadow hover:bg-amber-700 transition-all font-semibold text-xs"
//                   onClick={() => handleGenerateClick(cert?.student, cert.courseName)}
//                 >
//                   Generate
//                 </button>
//               )}
...
//       {/* Modal for certificate generation */}
//       {showCertModal && modalStudent && modalCourseName && (
//         <div className=" inset- bg-black/40 flex items-center justify-center z-50">
//           <div className="bg-white rounded-xl shadow-2xl w-full max-w- p-8 relative">
//             <button
//               className="absolute top-2 right-4 text-2xl text-gray-400 hover:text-gray-700"
//               onClick={() => setShowCertModal(false)}
