...
//   const selectedCourse = courses.find((c) => c.id === courseId);
//   const totalFee =
//     (selectedCourse?.fees.courseFee || 0) +
//     (selectedCourse?.fees.admissionFee || 0);
...
//       <div
//         ref={formRef}
//         className={`max-w-2xl mx-auto bg-white border-t-4 border-blue-500 rounded-2xl shadow-lg transition-all duration-300 overflow-hidden ${
//           formOpen ? "opacity-100 p-6" : "max-h-0 opacity-0 p-0"
//         }`}
//       >
//         <h2 className="text-center text-2xl font-bold mb-6 text-blue-600">
//           {editId ? "Edit Student" : "Create New Student"}
