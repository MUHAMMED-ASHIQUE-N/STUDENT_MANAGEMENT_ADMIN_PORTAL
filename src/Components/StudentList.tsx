...
function StudentList({ onEdit, courses, students }: { onEdit: (student: any) => void; courses: Coursetype[]; students:StudentDetails[] }) {
  ...
  return (
    <div className="mt-8 md:mt-18 bg-white rounded-xl shadow-lg p-6">
                ...
                <td className="py-3 px-4 relative group">
                  <div className=" right-0 mt-1 flex ">
                    <button
                      ...
                      className="w-full px-2 py-2 hover:bg-blue-100 "
                    >
                    ...
                    <button
                      ...
                      className=" px-3 py-2 hover:bg-blue-100 text-red-500"
                    >
